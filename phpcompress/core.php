...
class compress_core{
	/***php的變數 設定*****/
	//不改的變數
	var $no_change=array('','p','P','_p','MYDB','DB','user','error','tpl','MYUI','MY_TMP_UI');
	...
	public $unChange_class=array('PHPMailer','tpl','fck','zipfile','MYUI','MY_TMP_UI','PHPExcel','PHPExcelWriter','FacebookApiException','BaseFacebook','Facebook','plugin_multipleSearch');
	public $unChange_function=array('item','loadXml','load','getAttribute','loadXML','read','opendir','createElement','importNode','appendChild','setAttribute','setTimezone','format','create','query','clear','connect','show','getOptionTemplate_plugin1','plugin_module_simpleSearchList','newBtn','plugin_module_multipleSearch'
	//ext
	,'addExt','__get','__call','__construct'
	//form
	,'ns','mail','email','image','min','max','azn','govId','passport','uniformCode','pswd'
	//_system
	,'actInsert','plugin_changeSelectUI','plugin_changeRadioUI','deleteImage','select_list','multipleDataDB_addNew','multipleDataDB_delete','toTop','unTop','setBelowTop','savePayLog'
	//ui 用
	,'list_print','list_sql','edit_print','edit_sql','searchSql','select_sql','clone_sql','clone_print','user_id','userLevel','input','bigImage','tinytext','BTN_action','BTN_delete','BTN_move','BTN_edit','table','link','selectUI','primary','hidden','textarea','newTableStart','newTableEnd','newLine','createTime','getNew','foreAdmin');
	//class專用的
	//檢查變數後是否接->
